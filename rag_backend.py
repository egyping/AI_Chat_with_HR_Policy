...
#5c. Load the data, embed and stor in vector db
def hr_index():
    ...
    data_load=PyPDFLoader('https://hr-public.s3.eu-west-1.amazonaws.com/HR+Policies+and+Procedures+Manual+-+BTQ+-+KW+-+SOP+-+001.01.pdf')
